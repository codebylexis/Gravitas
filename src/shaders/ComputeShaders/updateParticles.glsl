...
// Semi-implicit Euler integration — GPU compute shader.
// Advances particle positions and velocities by one time step using forces
// computed in the previous force-calculation pass.
// (The CPU counterpart uses leapfrog; see ParticleSystem::updateParticlePosition.)
