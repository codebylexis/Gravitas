// Sequential Barnes-Hut CPU solver.
// Each frame: reset → insert all particles → propagate masses → prune empty
// nodes → compute forces (one octree walk per particle) → integrate positions.
